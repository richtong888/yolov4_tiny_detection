...
modelConfiguration = "yolov4-tiny-faceside.cfg"
modelWeights = "yolov4-tiny-faceside_20000_0207.weights"
...
def getOutputsNames(net):
    ...
    # Get the names of the output layers, i.e. the layeDNN_BACKEND_CUDArs with unconnected outputs
